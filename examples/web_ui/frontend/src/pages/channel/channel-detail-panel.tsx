...
export function ChannelDetailPanel({
        ...
        const text = (value: React.ReactNode) => <span className="font-mono">{value}</span>;
        ...
        for (const [key, def] of Object.entries(configProperties)) {
                ...
                configRows.push({
                        label: t(`channel.fields.${key}.title`, {
                                ...
                                <section>
                                        ...
                                        <div className="overflow-hidden rounded-lg border">
                                                <Table>
                                                        ...
                                                        <TableBody>
                                                                {channel.routing.bindings.map((binding, index) => {
                                                                        const isCatchAll =
                                                                                index === channel.routing.bindings.length - 1;
                                                                        return (
                                                                                <TableRow key={index}>
                                                                                        <TableCell className="px-3 py-2 font-mono text-xs">
                                                                                                {isCatchAll
                                                                                                        ? t(
                                                                                                                  'channel.binding.fallback',
                                                                                                          )
                                                                                                        : `${binding.match_key} = ${binding.match_value}`}
                                                                                        </TableCell>
                                                                                        <TableCell className="w-6 px-0 text-center">
                                                                                                <ArrowRight className="inline size-3.5 text-muted-foreground" />
                                                                                        </TableCell>
                                                                                        <TableCell className="px-3 py-2 text-xs">
                                                                                                {agentName(binding.agent_id)}
                                                                                        </TableCell>
                                                                                        <TableCell className="px-3 py-2 text-xs text-muted-foreground">
                                                                                                {t(
                                                                                                        `channel.sessionScope.${binding.session_scope}`,
                                                                                                )}
                                                                                        </TableCell>
                                                                                </TableRow>
                                                                        );
                                                                ...
                                                                <TableBody>
                                                                        {sessions.map((session) => (
                                                                                <TableRow
                                                                                        ...
                                                                                        onClick={() =>
                                                                                                navigate(
                                                                                                        `/chat/${session.agent_id}/${session.id}`,
                                                                                                )
                                                                                        }
                                                                                        title={t(
                                                                                                'channel.sessions.openInChat',
                                                                                        )}
                                                                                >
